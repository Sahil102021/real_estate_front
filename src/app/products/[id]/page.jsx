        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
            <div className="flex justify-between">
              ...
              <span className="text-gray-900">${property.price.toLocaleString()}</span>
            </div>
            <div className="flex justify-between">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-gray-900">{property.furnicher ? "Yes" : "No"}</span>
            </div>
          </div>
          ...
          <div className="mb-6">
            <h2 className="text-2xl font-semibold text-gray-800 mb-2">Other Details</h2>
